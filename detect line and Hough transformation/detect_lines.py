...
def onTrackbarChange(max_slider):
    ...
    lines = cv2.HoughLinesP(edges, 2, np.pi/180.0, 50,
...
if __name__ == "__main__":
    ...
    cv2.createTrackbar("threshold", "Imagen Resultante",
                       initThresh, maxThresh, onTrackbarChange)
