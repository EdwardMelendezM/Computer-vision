...
def onTrackbarChange(max_slider):
    ...
    if circles is not None:
        # almacenar la longitud de los círculos encontrados
...
if __name__ == "__main__":
    # Leer imagen
    img = cv2.imread("src/brown-eyes.jpg", 1)
    ...
    cv2.createTrackbar("Threshold", "Image", initThresh,
                       maxThresh, onTrackbarChange)
