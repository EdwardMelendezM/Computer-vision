...
haarcascade_car = 'src/opencv_xml_files/haarcascade_car.xml'
haarcascade_fullbody = 'src/opencv_xml_files/haarcascade_fullbody.xml'
...
cap = cv2.VideoCapture('src/cars.avi')
